...
function singlePlayerStart(difficulty) {
    ...
    //AI functions
    function bot(difficulty) {
        if (difficulty == "easy") {
            //easy
            console.log(difficulty);
            compSquareRand = randomSquare();
            var square = ".square-" + compSquareRand.toString();
            console.log(square);
            displayO(square);
        }
